...
<c:url value="/admin/goods/createGoodsStandard.do" var="createGoodsStandardUrl"/>
<form:form method="post" modelAttribute="goodsStandard" action="${createGoodsStandardUrl}" enctype="multipart/form-data" name="f" id="f">
	...
	<!-- 商品详情-->
	商品详情：
	<form:textarea path="goodsBrief"></form:textarea> <br>
	<script>
	...
	<div class="btn btn-default" onclick="createGoodsStandard()">创建</div>
...
function createGoodsStandard() {
    ...
    $.ajax({
        url: '${createGoodsStandardUrl}?${_csrf.parameterName}=${_csrf.token}',
        type: 'POST',
        dataType: "json",
        data: data,
        cache: false,
        ...
        success: function(result) {
            ...
            if (result.code == 0) {
                location.replace('/admin/goods/goodsStandardList.do');
            }
        },
        error: function() {
